...
> 详细使用示例：[埋点事件示例](https://growingio.github.io/growingio-sdk-docs-v3/docs/basicknowledge/trackEventUse#埋点事件示例)
...
> 详细使用示例：[用户属性事件示例](https://growingio.github.io/growingio-sdk-docs-v3/docs/basicknowledge/trackEventUse#用户属性事件示例)
